...
export const migration007: Migration = {
  ...
  up: `
    CREATE TABLE IF NOT EXISTS invoice_styles (
      ...
      description TEXT,
      logo_id INTEGER,
      primary_color TEXT NOT NULL DEFAULT '#0047AB',
      header_color TEXT NOT NULL DEFAULT '#0047AB',
      accent_color TEXT NOT NULL DEFAULT '#0047AB',
      footer_color TEXT NOT NULL DEFAULT '#0047AB',
